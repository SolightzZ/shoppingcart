            ...
            <tbody> 
                <?php if($rows > 0): ?>
                    ...
                    <tr> 
                        ...
                        <td>
                            <a onclick="return confirm('Are your sure you want to delete?');" role="button" href="<?php echo $base_url; ?>/cat-delete.php?id=<?php echo $product['id']; ?>" class="btn -btn-outline-danger"><i class="fa-solid fa-trash"></i>Delete</a>
                        </td> 
                    </tr> 
                    <?php endwhile; ?>
                    <tr>
                        ...
                        <a href="<?php echo $base_url; ?>/checkout.php" class="btn btn-lg btn-primary">Checkup Order</a>
                        </td>
                    </tr>
                <?php else: ?>
                    <tr>
                        <td colspan="4"><h4 class="text-center text-danger">ไม่มีรายการสินค้าในตะกร้า</h4></td>
                    </tr>
                    <?php endif; ?>
                </tbody> 
            </table> 
